        ...
        <div class="dvkss-column dvkss-secondary">
            <div class="dvkss-box">
                ...
                <ul class="ul-square">
                    ...
                    <li><a href="https://x.com/intent/post?text=<?php echo urlencode('Need social sharing options for your WordPress site? This plugin is great: '); ?>&url=<?php echo urlencode('https://wordpress.org/plugins/dvk-social-sharing/'); ?>">Tweet about this plugin</a></li>
                </ul>
